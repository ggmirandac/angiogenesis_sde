...
n_reps = 100_000
L = cholesky(cov_matrix(n_steps, 0.75)).L
...
JLD.save("jlds/fbm_final_pos075.jld", "fbm_final_x", fbm_final_x)
JLD.save("jlds/fbm_distance075.jld", "distance_fbm", distance_fbm)
